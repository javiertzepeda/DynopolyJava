...
public class Main {
	...
	public static void main(String[] args) {
		...
		/* Sets up board */
		String loc0 = "Go";
		Engine.board[0] = new Location(loc0, GO, 0, 0, 0);
		String loc1 = "Mediterranean Ave.";
		Engine.board[1] = new Location(loc1, PROPERTY, 60, 50, 2);
		String loc2 = "Baltic Ave.";
		Engine.board[2] = new Location(loc2, PROPERTY, 60, 50, 4);
		String loc3 = "Oriental Ave.";
		Engine.board[3] = new Location(loc3, PROPERTY, 100, 50, 6);
		String loc4 = "Vermont Ave.";
		Engine.board[4] = new Location(loc4, PROPERTY, 100, 50, 6);
		String loc5 = "Connecticut Ave.";
		Engine.board[5] = new Location(loc5, PROPERTY, 120, 50, 8);
		String loc6 = "Jail";
		Engine.board[6] = new Location(loc6, JAIL, 0, 0, 0);
		String loc7 = "St. Charles Place";
		Engine.board[7] = new Location(loc7, PROPERTY, 140, 50, 10);
		String loc8 = "States Ave.";
		Engine.board[8] = new Location(loc8, PROPERTY, 140, 0, 10);
		String loc9 = "Virginia Ave.";
		Engine.board[9] = new Location(loc9, PROPERTY, 160, 50, 12);
		String loc10 = "St. James Place";
		Engine.board[10] = new Location(loc10, PROPERTY, 180, 50, 14);
		String loc11 = "Tennessee Ave.";
		Engine.board[11] = new Location(loc11, PROPERTY, 180, 50, 14);
		String loc12 = "New York Ave.";
		Engine.board[12] = new Location(loc12, PROPERTY, 200, 50, 16);
		String loc13 = "Free Parking";
		Engine.board[13] = new Location(loc13, FREEPARKING, 0, 0, 0);
		String loc14 = "Kentucky Ave.";
		Engine.board[14] = new Location(loc14, PROPERTY, 220, 50, 18);
		String loc15 = "Indiana Ave.";
		Engine.board[15] = new Location(loc15, PROPERTY, 220, 50, 18);
		String loc16 = "Illinois Ave.";
		Engine.board[16] = new Location(loc16, PROPERTY, 240, 50, 20);
		String loc17 = "Atlantic Ave.";
		Engine.board[17] = new Location(loc17, PROPERTY, 260, 50, 22);
		String loc18 = "Ventnor Ave.";
		Engine.board[18] = new Location(loc18, PROPERTY, 260, 50, 22);
		String loc19 = "Marvin Gardens";
		Engine.board[19] = new Location(loc19, PROPERTY, 280, 50, 24);
		String loc20 = "Go To Jail";
		Engine.board[20] = new Location(loc20, GOTOJAIL, 0, 0, 0);
		String loc21 = "Pacific Ave.";
		Engine.board[21] = new Location(loc21, PROPERTY, 300, 50, 26);
		String loc22 = "North Carolina Ave.";
		Engine.board[22] = new Location(loc22, PROPERTY, 300, 50, 26);
		String loc23 = "Pennsylvania Ave.";
		Engine.board[23] = new Location(loc23, PROPERTY, 320, 50, 28);
		String loc24 = "Park Place";
		Engine.board[24] = new Location(loc24, PROPERTY, 350, 50, 35);
		String loc25 = "Boardwalk";
		Engine.board[25] = new Location(loc25, PROPERTY, 400, 50, 50);
		...
		while (!Engine.hasGameEnded()) {
			...
			if (!Engine.isPlayerJailed()) { // Before moving player, checks to see if a Player is in jail and needs to pay a fine
				...
				String currentPlayerLocation = Engine.board[Engine.players[Engine.currentPlayer].getLocation()].getLocationName(); // gets string data for the location that CurrentPlayer moved to 
				Engine.board[Engine.players[Engine.currentPlayer].getLocation()].incrementLandingCount(); // increase variable in location that stores the number of times a player has landed on it
